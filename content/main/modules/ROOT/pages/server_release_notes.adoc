...
* The xref:11.0@server:developer_manual:webdav_api/trashbin.adoc[WebDAV Trash bin API] and the xref:11.0@server:developer_manual:webdav_api/public_files.adoc[WebDAV endpoint for public links] (introduced with 10.3.0) have left the tech preview state.
...
* A new xref:11.0@server:developer_manual:core/apis/ocs-user-sync-api.adoc[OCS User Sync API] to trigger user sync from external user backends has been added.
...
* xref:11.0@server:developer_manual:webdav_api/trashbin.adoc[WebDAV Trash bin API].
* xref:11.0@server:developer_manual:core/apis/ocs-notify-public-link-by-email.adoc[OCS API for public link share email notifications]
* xref:11.0@server:developer_manual:webdav_api/public_files.adoc[WebDAV endpoint for public links].
...
* A new Roles API has been added to allow clients to query the server for available permissions/roles for user/group sharing and public links.
  In future client releases, this endpoint will be used to dynamically display roles/permissions depending on the server's capabilities. You can find out more about it in xref:11.0@server:developer_manual:core/apis/roles-api.adoc[the Roles API documentation].
...
docs at
xref:11.0@server:developer_manual:app/fundamentals/classloader.adoc
...
xref:11.0@server:developer_manual:core/theming.adoc[Changing favicon] in the Developer Manual.
